VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} Fy_セル入力4 
   Caption         =   "セル入力4"
   ClientHeight    =   3720
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   4410
   OleObjectBlob   =   "Fy_セル入力4.frx":0000
   ShowModal       =   0   'False
   StartUpPosition =   1  'オーナー フォームの中央
End
Attribute VB_Name = "Fy_セル入力4"
...
Private Function fsInputCheck() As Boolean
  Dim wMSG     As String
  Dim w入力01  As String, w入力02 As String, w入力03 As String, w入力04 As String
